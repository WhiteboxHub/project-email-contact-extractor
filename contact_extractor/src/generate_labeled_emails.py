...
#     # AI/ML and Fullstack UI specific subjects
...
# # Spam/junk/newsletter templates (negative)
# # Add more realistic spammy/blacklist/ignore patterns from rules.yaml
...
# # Gray area: ambiguous job alerts, networking, or generic business emails (negative)
# gray_subjects = [
...
# # Generate recruiter/vendor emails (label=1)
# for _ in range(3000):
...
# # Generate spam/junk/newsletter/blacklist/gray emails (label=0)
# for _ in range(3000):
#     # 70% blacklist spam, 20% gray area, 10% generic
#     r = random.random()
#     if r < 0.7:
